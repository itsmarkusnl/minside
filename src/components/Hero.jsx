    ...
    <section id="topp" className={styles.hero}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.socials}>
          <a href="https://github.com/itsmarkusnl" target="_blank" rel="noopener noreferrer" aria-label={h.ariaGitHub}>
          ...
          <a href="https://www.linkedin.com/in/markus-nipen-larsen-4769331a3/" target="_blank" rel="noopener noreferrer" aria-label={h.ariaLinkedIn}>
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
